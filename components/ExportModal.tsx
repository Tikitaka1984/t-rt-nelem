  ...
  return (
    ...
    >
      <div
        ...
        className="relative w-full max-w-2xl bg-white dark:bg-[#16213e] rounded-lg shadow-xl m-4 animate-fade-in transition-colors duration-300"
        onClick={e => e.stopPropagation()}
      >
        <div className="p-6">
          <div className="flex justify-between items-center mb-4">
            <h3 id={titleId} className="text-xl font-semibold">Exportálás / Másolás</h3>
            <button onClick={onClose} className="p-1 rounded-full hover:bg-gray-200 dark:hover:bg-[#2a2a4e]" aria-label="Bezárás">
          ...
          <div className="p-4 bg-gray-100 dark:bg-[#1a1a2e] rounded-md max-h-96 overflow-y-auto whitespace-pre-wrap text-sm transition-colors duration-300">
            {getExportText()}
          </div>
          <button
            onClick={handleCopy}
            className="mt-4 w-full flex items-center justify-center px-4 py-2 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-[#16213e] focus:ring-blue-500 transition-colors"
          >
